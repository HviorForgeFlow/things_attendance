...
class HrAttendance(models.Model):
    ...
    check_in_source = fields.Char(
        string="Source of the Check-In TimeStamp",
        default=h.defaultClockingSource,
        required=True,
    )
    check_out_source = fields.Char(
        string="Source of the Check-Out TimeStamp",
        default=h.defaultClockingSource,
        required=True,
    )
    ...
    def add_clocking(
        ...
        if helper.warningMessage:
            return helper.warningMessage
